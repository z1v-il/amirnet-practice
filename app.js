...
async function generateRestatement() {
    ...
    const promptText = `Expert Amirnet test writer. Generate 1 "Restatement" question (Upper-B2/C1). RULES: 1. Academic original sentence (18-25 words). CRITICAL: Randomize the sentence structure! Sometimes use contrast (Despite/Although), sometimes Conditionals (If/Unless), sometimes Cause/Effect (Because/Consequently), or Relative clauses. 2. The correct restatement MUST alter the syntactic structure, NOT just swap synonyms. 3. All 4 options roughly same length. 4. Keep HEBREW explanation under 12 words. Format raw JSON: { "original": "...", "options": ["Correct option...", "Incorrect 1...", "Incorrect 2...", "Incorrect 3..."], "explanation": "Short Hebrew explanation" }`;
...
async function generateFullExam() {
    ...
    const promptRestates = `Expert Amirnet test writer. Generate JSON array of 6 "Restatement" questions (Upper-B2/C1). RULES: 1. Academic original (18-25 words). CRITICAL: Force high variety in sentence structures! MAXIMUM ONE sentence starting with "Despite" or "Although". The other 5 MUST use different structures like Conditionals (If/Unless), Cause/Effect, passive voice, or standard clauses. 2. Correct restatement MUST significantly alter syntactic structure, NOT just swap synonyms. 3. All 4 options roughly same word count. 4. Format raw JSON array: [ { "original": "...", "options": ["Correct restatement.", "Dist 1.", "Dist 2.", "Dist 3."], "correctIndex": 0, "explanation": "Short Hebrew explanation" } ] IMPORTANT: Exactly 6 objects. First option (index 0) MUST be correct. Keep explanation under 12 words.`;
